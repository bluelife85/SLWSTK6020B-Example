  ...
  while (1) {
    ...
    switch (BGLIB_MSG_ID(evt->header)) {
      ...
      case gecko_evt_gatt_server_user_write_request_id:
        ...
        else if(evt->data.evt_gatt_server_user_write_request.characteristic == gattdb_led1){

        	if(evt->data.evt_gatt_server_user_write_request.value.data[0] == '0'){
        		GPIO_PinOutClear(gpioPortF,4);
        	}
        	else if(evt->data.evt_gatt_server_user_write_request.value.data[0] == '1'){
        ...
        else if(evt->data.evt_gatt_server_user_write_request.characteristic == gattdb_led2){
